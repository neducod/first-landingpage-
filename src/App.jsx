    ...
    <div>
      ...
      <div className='flex justify-center flex-col p-4 sm:p-6 items-center'>
        ...
        <div className='flex justify-center items-center text-center w-full p-4 mb-8 mt-4'>
          <p className='text-gray-500 font-light w-full sm:w-1/2 sm:text-2xl'>Your research and thinking partner, grounded in the information you trust, built with the latest Gemini models.</p>
        </div>
